      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="glass-card p-8 rounded-2xl">
          ...
          <button onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-border/60 bg-card/40 hover:bg-card/80 text-sm font-medium transition-all duration-200 mb-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPass ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl bg-card/40 border border-border/60 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/60 focus:ring-1 focus:ring-primary/30 transition-all" />
